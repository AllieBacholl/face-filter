...
ensure_lib                                       ./libraries/fifo_HPS_to_FPGA_in_rsp_width_adapter/
vmap       fifo_HPS_to_FPGA_in_rsp_width_adapter ./libraries/fifo_HPS_to_FPGA_in_rsp_width_adapter/
ensure_lib                                       ./libraries/fifo_HPS_to_FPGA_in_burst_adapter/    
vmap       fifo_HPS_to_FPGA_in_burst_adapter     ./libraries/fifo_HPS_to_FPGA_in_burst_adapter/    
...
ensure_lib                                       ./libraries/fifo_HPS_to_FPGA_in_agent_rsp_fifo/   
vmap       fifo_HPS_to_FPGA_in_agent_rsp_fifo    ./libraries/fifo_HPS_to_FPGA_in_agent_rsp_fifo/   
ensure_lib                                       ./libraries/fifo_HPS_to_FPGA_in_agent/            
vmap       fifo_HPS_to_FPGA_in_agent             ./libraries/fifo_HPS_to_FPGA_in_agent/            
...
ensure_lib                                       ./libraries/fifo_HPS_to_FPGA_in_translator/       
vmap       fifo_HPS_to_FPGA_in_translator        ./libraries/fifo_HPS_to_FPGA_in_translator/       
...
ensure_lib                                       ./libraries/fifo_FPGA_to_HPS/                     
vmap       fifo_FPGA_to_HPS                      ./libraries/fifo_FPGA_to_HPS/                     
...
alias com {
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_width_adapter.sv"                                         -L altera_common_sv_packages -work fifo_HPS_to_FPGA_in_rsp_width_adapter
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_address_alignment.sv"                                     -L altera_common_sv_packages -work fifo_HPS_to_FPGA_in_rsp_width_adapter
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                                    -L altera_common_sv_packages -work fifo_HPS_to_FPGA_in_rsp_width_adapter
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter.sv"                                         -L altera_common_sv_packages -work fifo_HPS_to_FPGA_in_burst_adapter    
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter_uncmpr.sv"                                  -L altera_common_sv_packages -work fifo_HPS_to_FPGA_in_burst_adapter    
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter_13_1.sv"                                    -L altera_common_sv_packages -work fifo_HPS_to_FPGA_in_burst_adapter    
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter_new.sv"                                     -L altera_common_sv_packages -work fifo_HPS_to_FPGA_in_burst_adapter    
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_incr_burst_converter.sv"                                         -L altera_common_sv_packages -work fifo_HPS_to_FPGA_in_burst_adapter    
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_wrap_burst_converter.sv"                                         -L altera_common_sv_packages -work fifo_HPS_to_FPGA_in_burst_adapter    
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_default_burst_converter.sv"                                      -L altera_common_sv_packages -work fifo_HPS_to_FPGA_in_burst_adapter    
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_address_alignment.sv"                                     -L altera_common_sv_packages -work fifo_HPS_to_FPGA_in_burst_adapter    
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_stage.sv"                                     -L altera_common_sv_packages -work fifo_HPS_to_FPGA_in_burst_adapter    
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_base.v"                                       -L altera_common_sv_packages -work fifo_HPS_to_FPGA_in_burst_adapter    
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                                                             -work fifo_HPS_to_FPGA_in_agent_rsp_fifo   
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                                           -L altera_common_sv_packages -work fifo_HPS_to_FPGA_in_agent            
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                                    -L altera_common_sv_packages -work fifo_HPS_to_FPGA_in_agent            
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_translator.sv"                                      -L altera_common_sv_packages -work fifo_HPS_to_FPGA_in_translator       
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/Computer_System_fifo_FPGA_to_HPS.v"                                                                  -work fifo_FPGA_to_HPS                     
...
alias elab {
  echo "\[exec\] elab"
  eval vsim -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L altera_common_sv_packages -L error_adapter_0 -L border -L rsp_mux -L rsp_demux -L cmd_mux -L cmd_demux -L router_002 -L router -L avalon_st_adapter -L fifo_HPS_to_FPGA_in_rsp_width_adapter -L fifo_HPS_to_FPGA_in_burst_adapter -L ARM_A9_HPS_h2f_axi_master_wr_limiter -L fifo_HPS_to_FPGA_in_agent_rsp_fifo -L fifo_HPS_to_FPGA_in_agent -L ARM_A9_HPS_h2f_axi_master_agent -L fifo_HPS_to_FPGA_in_translator -L reset_from_locked -L sys_pll -L hps_io -L fpga_interfaces -L rst_controller -L irq_mapper -L mm_interconnect_1 -L mm_interconnect_0 -L fifo_FPGA_to_HPS -L System_PLL -L Onchip_SRAM -L ARM_A9_HPS -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
...
alias elab_debug {
  ...
  eval vsim -novopt -t ps $ELAB_OPTIONS $USER_DEFINED_ELAB_OPTIONS -L work -L work_lib -L altera_common_sv_packages -L error_adapter_0 -L border -L rsp_mux -L rsp_demux -L cmd_mux -L cmd_demux -L router_002 -L router -L avalon_st_adapter -L fifo_HPS_to_FPGA_in_rsp_width_adapter -L fifo_HPS_to_FPGA_in_burst_adapter -L ARM_A9_HPS_h2f_axi_master_wr_limiter -L fifo_HPS_to_FPGA_in_agent_rsp_fifo -L fifo_HPS_to_FPGA_in_agent -L ARM_A9_HPS_h2f_axi_master_agent -L fifo_HPS_to_FPGA_in_translator -L reset_from_locked -L sys_pll -L hps_io -L fpga_interfaces -L rst_controller -L irq_mapper -L mm_interconnect_1 -L mm_interconnect_0 -L fifo_FPGA_to_HPS -L System_PLL -L Onchip_SRAM -L ARM_A9_HPS -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cyclonev_ver -L cyclonev_hssi_ver -L cyclonev_pcie_hip_ver $TOP_LEVEL_NAME
}
