...
# ----------------------------------------
# If regFile is one of several IP cores in your
...
# ----------------------------------------
# ACDS 18.0 614 win32 2025.04.16.14:49:39
...
alias com {
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/regFile_onchip_regFile.v"    -work onchip_regFile
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/regFile.v"                                                  
}
